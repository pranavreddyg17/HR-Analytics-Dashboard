    ...
    <div className="mx-auto flex w-full max-w-[1520px] flex-col gap-5 pb-8">
      ...
      <section aria-labelledby="pulse-heading">
        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <Metric label="Training complete" value={`${percent.format(analytics.kpis.trainingCompletionRate)}%`} detail={`${incompleteTraining} mandatory follow-ups`} icon={GraduationCap} tone="bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-300" href="/learning" />
