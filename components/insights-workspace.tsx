...
export function InsightsWorkspace() {
  ...
  const workItems = [
    ...
    { priority: data.promotions.withoutPromotionOver36Months > 0 ? "Normal" : "Clear", item: "Mobility review", count: data.promotions.withoutPromotionOver36Months, definition: "Employees with 3+ years tenure and no recorded promotion", href: "/people", action: "Review people" },
  ]
