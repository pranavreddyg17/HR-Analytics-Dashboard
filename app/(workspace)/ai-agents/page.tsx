...
export default async function AiAgentsPage() {
  ...
  return (
    <WorkspacePage>
      <WorkspaceHeader title="AI assistant" description="Ask workforce questions or prepare a reviewed calendar action." />
      <AiAssistantWorkspace dataMode={mode.toLowerCase()} canPrepare={canPrepare} />
    </WorkspacePage>
  )
}
