  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-lg rounded-lg border border-border bg-card p-8 text-center shadow-none">
        ...
        <h2 className="mt-5 text-2xl font-semibold">Unable to load this page</h2>
        <p className="mt-2 text-sm text-muted-foreground">Your data was not changed. Try again. If the problem continues, check the connection status under Import / export data.</p>
