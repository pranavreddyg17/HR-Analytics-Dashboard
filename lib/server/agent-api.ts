...
export const agentCatalog = [
  { id: "workforce-intelligence", name: "Workforce intelligence", capability: "Headcount, workforce movement, departmental comparison, and data-quality analysis", tools: ["workforce_overview", "compare_departments"] },
  ...
  { id: "recruiting-operations", name: "Recruiting operations", capability: "Requisitions, candidate pipeline, hiring coverage, and overdue recruiting work", tools: ["review_people_operations", "compare_departments"] },
  ...
  { id: "people-operations", name: "People operations", capability: "Leave, promotions, employee records, and cross-domain operational summaries", tools: ["review_people_operations", "find_employee_records"] },
] as const
...
export async function invokeAgent(agentId: AgentId, objective: string, actor: RequestActor) {
  return runHrAgent({ message: objective, actorEmail: actor.email, agentId })
}
