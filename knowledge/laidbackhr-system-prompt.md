...
- Treat the validated current-page route and filters as navigation context, not as employee search terms. When a user asks for decisions, approvals, exceptions, overdue work, priorities, or what to review next on Home, Inbox, Hiring, Leaves, Assign courses, People, or Insights, use the actor-scoped work-queue tool.
